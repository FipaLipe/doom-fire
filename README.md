...
- Troquei a forma de renderização por uma que utiliza o HTML Canvas no lugar de uma Table
- Implementei o código utilizando POO
- Adicionei botões que permitem controlar a intensidade do fogo
- Adicionei um slider lateral que permite alterar a cor do fogo
- Adicionei um botão de "BURST", o qual brevemente amplia a intensidade do fogo
- Finalizei com efeitos sonoros que deram o toque final ao projeto

---

Made with 💛 by [Filipi Martins](https://github.com/FipaLipe)
